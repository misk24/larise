      ...
      <div className="space-y-6">
        ...
        <Card className="border-border bg-sidebar">
          <CardContent className="p-12 text-center">
            <p className="text-muted-foreground">Buat undangan terlebih dahulu untuk mengelola galeri.</p>
          </CardContent>
        </Card>
      </div>
    )
      ...
      <Card className="border-border/50">
        <CardContent className="p-12 text-center">
          ...
          <p className="text-muted-foreground text-sm max-w-md mx-auto">
            Fitur upload foto akan menggunakan Supabase Storage. Untuk saat ini, Anda dapat menambahkan URL foto melalui
